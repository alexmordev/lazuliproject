...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
    <div class="single-post">
        ...
        <div class="entry-content">
            <?php the_content(); ?>
            <?php if(get_theme_mod('jewellery_lite_toggle_tags',true)==1){ ?>
        ...
        <?php
            ...
            if ( is_singular( 'attachment' ) ) {
                ...
                the_post_navigation( array(
                    'next_text' => '<span class="meta-nav" aria-hidden="true">' .esc_html(get_theme_mod('jewellery_lite_single_blog_next_navigation_text','NEXT')) . '</span> ' .
                        '<span class="screen-reader-text">' . __( 'Next post:', 'jewellery-lite' ) . '</span> ' .
                        '<span class="post-title">%title</span>',
                    'prev_text' => '<span class="meta-nav" aria-hidden="true">' .esc_html(get_theme_mod('jewellery_lite_single_blog_prev_navigation_text','PREVIOUS')) . '</span> ' .
