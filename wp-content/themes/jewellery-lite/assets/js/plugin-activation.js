jQuery(document).ready(function($) {
    'use strict';
    var this_obj = jewellery_lite_plugin_activate_plugin;
    ...
    $(document).on('click', '.jewellery-lite-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message jewellery-lite-plugin-install');
                button.addClass('button-primary jewellery-lite-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.jewellery-lite-recommended-plugins .jewellery-lite-activation-note').css('display','block');
    ...
    $(document).on('click', '.jewellery-lite-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .jewellery-lite-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .jewellery-lite-recommended-plugins').css('display','none');
    });
