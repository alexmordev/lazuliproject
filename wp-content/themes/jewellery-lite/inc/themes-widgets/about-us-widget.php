...
class Jewellery_Lite_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Jewellery_Lite_About_Widget',
			__('VW About us', 'jewellery-lite'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'jewellery-lite' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','jewellery-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','jewellery-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','jewellery-lite'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','jewellery-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','jewellery-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','jewellery-lite'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function jewellery_lite_about_custom_load_widget() {
	register_widget( 'Jewellery_Lite_About_Widget' );
}
add_action( 'widgets_init', 'jewellery_lite_about_custom_load_widget' );