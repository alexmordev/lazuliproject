...
class Jewellery_Lite_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'jewellery-lite' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $jewellery_lite_font_awesome_icon_array = jewellery_lite_font_awesome_icon_array();
                    foreach ($jewellery_lite_font_awesome_icon_array as $jewellery_lite_font_awesome_icon) {
                            $icon_class = $this->value() == $jewellery_lite_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($jewellery_lite_font_awesome_icon).'"></i>
                            <span class="jewellery-lite-social-class">'.esc_attr($jewellery_lite_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function jewellery_lite_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'jewellery-lite-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'jewellery_lite_customizer_script' );

if(!function_exists('jewellery_lite_font_awesome_icon_array')){
    function jewellery_lite_font_awesome_icon_array(){
